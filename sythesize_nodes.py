...
class SynthesizedNode:
    def __init__(self, id, name):
        ...
        if self.name.find("Scan") >= 0:
            ...
            self.operator = Operator.Exchange
        ...
        elif self.name.find("SortAggregate") >=0:
            self.operator = Operator.SortAggregate
        ...
        elif self.name.find("Window") >= 0:
            self.operator = Operator.Window
        elif self.name.find("ColumnarToRow") >= 0:
            self.operator = Operator.ColumnarToRow
